...
export const WelcomeSlide = () => {
  return <div className="h-full w-full relative animate-fade-in">
      {/* Background image - scaled up to compensate for parent 94% scale */}
      <img src={welcomeBg} alt="Atelier Jean-Regniers" className="absolute inset-[-4%] w-[108%] h-[108%] object-cover" />
