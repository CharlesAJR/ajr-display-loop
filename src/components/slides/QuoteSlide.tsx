...
export const QuoteSlide = () => {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center bg-background px-16 animate-fade-in relative overflow-hidden">
      ...
      <svg 
        className="absolute top-20 left-20 w-96 h-96 text-ajr-violet opacity-5" 
        fill="currentColor" 
        viewBox="0 0 24 24"
      >
      ...
      <svg 
        className="absolute bottom-20 right-20 w-96 h-96 text-ajr-fuchsia opacity-5 rotate-180" 
        fill="currentColor" 
        viewBox="0 0 24 24"
      >
        <path d="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z" />
      ...
      <div className="max-w-6xl mx-auto relative z-10 bg-muted/30 backdrop-blur-md rounded-3xl p-16 border border-border/50 shadow-2xl">
        <div className="text-center">
          <p className="text-foreground text-6xl font-display leading-tight italic font-light mb-8">
            "{quote.text}"
          </p>
          <cite className="not-italic text-4xl font-display text-ajr-violet font-medium">
            — {quote.author}
          </cite>
        </div>
      </div>
