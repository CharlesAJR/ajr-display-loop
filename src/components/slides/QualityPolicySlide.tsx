      ...
      <div className="max-w-6xl w-full px-12 py-8">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Certifications */}
            <div className="p-6 rounded-2xl bg-ajr-blue text-white">
              <h2 className="text-2xl font-semibold mb-4">
                Nos Certifications
              </h2>
              <div className="flex flex-wrap gap-4">
                {qualityPolicy.certifications.map((cert, index) => (
                  <div 
                    key={index}
                    className="px-4 py-2 rounded-full bg-white/20 border border-white/40 text-white font-medium"
                  >
                    {cert}
                  </div>
                ))}
            ...
            {/* Message final */}
            <div className="text-center p-4 rounded-xl bg-ajr-pink/20 border border-ajr-pink/40">
