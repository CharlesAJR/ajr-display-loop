    ...
    <div className={`h-full w-full relative overflow-hidden ${className}`} style={{ background: 'linear-gradient(135deg, #007baf 0%, #005a82 50%, #004466 100%)' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -top-20 -right-20 w-[660px] h-[660px]"
          style={{
        ...
        <motion.div
          ...
          className="absolute top-[20%] -left-10 w-[330px] h-[440px]"
          style={{
        ...
        <motion.div
          ...
          className="absolute bottom-[15%] right-[10%] w-[220px] h-[220px]"
          style={{
        ...
        <motion.div
          ...
          className="absolute top-[60%] left-[15%] w-[165px] h-[165px] rounded-full"
          style={{
        ...
        <motion.div
          ...
          className="absolute bottom-[30%] left-0 w-[44%] h-[2px]"
          style={{
        ...
        <motion.div
          ...
          className="absolute -bottom-10 -left-10 w-[275px] h-[275px]"
          style={{
